...
class AzureCallServer:
            ...
            async with connect(
                ...
                async def twilio_to_azure():
                    ...
                    async for message in websocket:
                        ...
                        if data['event'] == 'start':
                            ...
                            await conn.input_audio_buffer.append(audio=data['media']['payload'])
                ...
                async def azure_to_twilio():
                    ...
                    async for event in conn:
                        await self._handle_azure_event(event, websocket, stream_sid)
    ...
    async def _handle_azure_event(self, event, websocket, stream_sid):
